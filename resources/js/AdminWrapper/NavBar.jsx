...
//             // console.log("Formatted notifications:", formattedNotifications); // Debug log
...
//     // Format timestamp to relative time - FIXED VERSION
...
//     // Close menus when route changes - FIXED
//     useEffect(() => {
...
//         // Listen to Inertia events if using Inertia.js
...
//                                                 className="text-xs text-blue-600 hover:text-blue-800 transition-colors duration-150 block text-center"
//                                             >
