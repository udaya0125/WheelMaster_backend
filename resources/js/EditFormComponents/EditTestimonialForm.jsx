...
const EditTestimonialForm = ({ onClose, editingTestimonial, onUpdate }) => {
    ...
    // Determine what to show: new image preview takes priority over existing image
    const hasNewImage = testimonialForm.author_image instanceof File;
    const showDropzone = !hasNewImage && !existingImage;
        ...
        <div className="w-full">
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-4">
                    ...
                    {/* Allow uploading a replacement even when an existing image is shown */}
                    {!hasNewImage && existingImage && (
                    ...
                    {(showDropzone || (!hasNewImage && existingImage)) && (
                        <div
