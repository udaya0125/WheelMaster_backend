...
const EditUserForm = ({ editingUser, onClose, onSuccess }) => {
    ...
    const fieldBaseClass = (field, disabled = false) =>
        `w-full pl-10 pr-3 py-2.5 border rounded-lg text-sm placeholder-gray-400 transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500/40 focus:border-indigo-500 ${
            disabled
    ...
    return (
        <div className="relative">
            <form onSubmit={handleSubmit} className="pt-1">
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                value={formData.email}
                                onChange={handleChange}
                                className={fieldBaseClass("email", true)}
                            />
                        </div>
                ...
                <div className="flex items-start gap-2 mt-5 mb-1 rounded-lg bg-gray-50 border border-gray-200 px-3 py-2.5">
                    <FiLock className="text-gray-400 mt-0.5" size={14} />
                    <p className="text-xs text-gray-500">
                        Password changes aren't available from this form.
                    </p>
                </div>

                <div className="flex space-x-3 pt-5 mt-4 border-t border-gray-100">
                    <button
                        type="button"
                        onClick={onClose}
                        disabled={submitting}
