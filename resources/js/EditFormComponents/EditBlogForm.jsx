...
const EditBlogForm = ({ blog, onClose, onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formDataToSend.append("short_description", blogForm.short_description);
      formDataToSend.append("long_description", blogForm.long_description);
  ...
  return (
    <div className="w-full max-w-4xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {/* DURATION */}
        <div>
          <label className="block text-sm font-medium mb-2">Read Duration *</label>
          <input
            type="text"
            name="duration"
