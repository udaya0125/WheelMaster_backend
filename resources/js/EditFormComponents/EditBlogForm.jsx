...
//                 setCurrentImage(`${imgurl}/${blog.image}`);
//             }
//         }
//     }, [blog]);
...
//             formDataToSend.append("_method", "PUT"); // Important for Laravel update
...
//                 route("ourblog.update", { id: blog.id }),
//                 formDataToSend,
//                 {
//                     headers: {
...
const EditBlogForm = ({ blog, onClose, onSuccess }) => {
    ...
    // Handle new image selection with size validation
    ...
    // New image takes priority over existing image
    const hasNewImage = blogForm.image instanceof File;
    const showDropzone = !hasNewImage && !currentImage;
        ...
        <div className="w-full max-w-4xl mx-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-4">
                    ...
                    {(hasNewImage || currentImage) && (
                        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mb-4">
                            <div className="relative group">
                                <img
                                    src={hasNewImage ? imagePreview : currentImage}
                                    alt={hasNewImage ? "New Preview" : "Current"}
                    ...
                    {/* Hint to replace existing image */}
                    {!hasNewImage && currentImage && (
                    ...
                    {/* File Input - shown when no image at all, or to allow replacing existing image */}
                    {(showDropzone || (!hasNewImage && currentImage)) && (
                        <div
