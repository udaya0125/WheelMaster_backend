...
<head>
    ...
    <style>
        ...
        .notice-box { background: #eef2ff; border: 1px solid #c7d2fe; padding: 18px; margin: 18px 0; border-radius: 8px; }
...
<body>
    ...
    <div class="content">
        ...
        @else
            ...
            <p>Your booking details are listed below. If Wheel Master Driving Academy needs to make any changes to your selected slot timing, we will contact you directly.</p>
        @endif
        ...
        @else
            <div class="notice-box">
                <h3 style="margin-top: 0; color: #3730a3;">Important Information</h3>
                <p style="margin-bottom: 0;">Please keep an eye on your phone and email. If any slot timing needs to be adjusted, Wheel Master Driving Academy will contact you directly before making changes.</p>
            </div>
